...
export default function Hero() {
  ...
  return (
    <section id="home" ref={ref} className="relative min-h-screen overflow-hidden">
      ...
      <motion.div
        style={{ y: bgY }}
        className="absolute inset-0 bg-gradient-to-b from-primary-dark via-primary to-accent-teal"
      >
        {/* Decorative circles */}
        <div className="absolute top-20 left-10 w-72 h-72 bg-accent-yellow/10 rounded-full blur-3xl animate-float" />
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-accent-pink/10 rounded-full blur-3xl animate-float-slow" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-white/5 rounded-full blur-3xl" />
      </motion.div>

      <motion.div style={{ opacity }} className="relative z-10 flex flex-col items-center justify-center min-h-screen pt-24 pb-16 px-4">
        {/* Doves */}
        <div className="absolute top-24 left-[10%] w-16 animate-fly">
          <Dove delay={0} />
        </div>
        <div className="absolute top-32 right-[15%] w-14 animate-fly-alt">
          <Dove delay={0.3} />
        </div>
        <div className="absolute top-48 left-[30%] w-12 animate-fly" style={{ animationDelay: "2s" }}>
          <Dove delay={0.6} />
        </div>
        <div className="absolute top-40 right-[35%] w-10 animate-fly-alt" style={{ animationDelay: "3s" }}>
          <Dove delay={0.9} />
        </div>

        {/* Tree illustration */}
        <div className="w-64 sm:w-80 md:w-96 mb-6">
          <TreeSVG />
        </div>
        ...
        <div className="text-center space-y-4 max-w-3xl">
          <motion.div
            ...
            className="inline-block bg-white/15 backdrop-blur-md text-white/90 text-xs sm:text-sm px-4 py-1.5 rounded-full font-medium tracking-wide"
          >
            Welcome to Zinnia Nursery Daycare Centre
          </motion.div>
          ...
          <motion.p
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 3 }}
            className="text-white/80 text-base sm:text-lg md:text-xl max-w-xl mx-auto"
          >
          ...
          >
            <a
              href="#booking"
              className="bg-secondary hover:bg-secondary-dark text-white px-8 py-3.5 rounded-full font-semibold text-base transition-all hover:shadow-xl hover:shadow-secondary/30 hover:-translate-y-1"
            >
              Book a Tour
            </a>
            <a
              href="#about"
              className="bg-white/15 hover:bg-white/25 backdrop-blur-md text-white px-8 py-3.5 rounded-full font-semibold text-base transition-all border border-white/20"
            >
              Learn More
            </a>
          </motion.div>
